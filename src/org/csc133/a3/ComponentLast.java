...
public class ComponentLast extends Component
{
    ...
    public void paint(Graphics g)
    {
        ...
        g.drawImage(lastDigit, displayX + 0 * displayDigitWidth, displayY, displayDigitWidth, displayDigitHeight);
