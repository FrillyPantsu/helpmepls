...
public class ComponentDamage extends Component {
    ...
    int numDigits = 2;
    boolean yellowLife = false;
    boolean redLife = false;

    ComponentDamage(GameWorld gw)
    {
        this.gw = gw;
        try
        {
    ...
    {
        int dam = (int)gw.player.getDamage();
    ...
    public void paint(Graphics g)
    {
        ...
        g.drawImage(damageDigits[0], displayX + 0 * displayDigitWidth, displayY, displayDigitWidth, displayDigitHeight);
        g.drawImage(damageDigits[1], displayX + 1 * displayDigitWidth, displayY, displayDigitWidth, displayDigitHeight);
